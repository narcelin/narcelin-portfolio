      ...
      <div className="md:grid md:grid-cols-2 gap-8 items-start py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
        ...
        <div>
          ...
          <p className="text-pText md:text-md">
            {`Well, hello there, and welcome to my portfolio! I'm Nicolas Arcelin Ovando, a dedicated Project Manager with a passion for solving problems. With over 4 years of hands-on experience in project management within the construction field, I've had the privilege of spearheading impactful projects where I've embraced opportunities for teaching and continuous learning. My journey has given me the skills to navigate complex situations and deliver results that exceed expectations. Whether it's coordinating tasks, managing resources, or ensuring seamless communication between all stakeholders, I thrive in dynamic environments where challenges are met with innovative ideas. One of my greatest strengths is my ability to connect with clients on a personal level, understanding their needs, and translating them into actionable plans. I take pride in fostering strong client relationships built on trust, effective communication, and understanding. I encourage you to explore the projects I've been involved in. Feel free to reach out! Whether it's for a professional connection or you just want to share a fun fact.`}
          </p>
